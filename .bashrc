...
if [ "$color_prompt" = yes ]; then
    PS1='[$(timeNow)]: ${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[00m\]:\[\033[01;34m\]\w\[\033[00m\]\$ '
else
...
__conda_setup="$('/home/stuart/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/stuart/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/stuart/anaconda3/etc/profile.d/conda.sh"
    else
